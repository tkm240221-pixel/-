...
const getRegions = (regionType: "seoul" | "gyeonggi" | "incheon") => {
  switch (regionType) {
    case "seoul":
      return seoulRegions
    case "gyeonggi":
...
export function RegionalLinks({ currentRegion, regionType }: RegionalLinksProps) {
  const regions = getRegions(regionType).filter((region) => region.slug !== currentRegion) || []

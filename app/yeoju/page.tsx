...
export default function YeojuMassage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-violet-600 via-purple-600 to-violet-800 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">여주시 출장마사지 예약문의 가이드</h1>
      ...
      <section className="py-16 bg-gradient-to-br from-violet-50 to-purple-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-8 text-violet-800">여주시 서비스 지역</h2>

...
export default function GanghwaPage() {
  return (
      ...
      <section className="relative bg-gradient-to-br from-slate-800 to-slate-900 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-purple-900 text-purple-300">강화군 전문 서비스</Badge>
            <h1 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              인천 강화군 출장마사지
              <span className="text-purple-400 block">프리미엄 홈케어</span>
            </h1>
            <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              인천 강화군 전 지역 30분 내 방문! 숙련된 전문 테라피스트가 직접 방문하여 최고의 힐링 서비스를 제공합니다.
            </p>
          </div>

          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-white mb-6">강화군 서비스 지역</h2>
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-slate-800 rounded-lg p-4">
                  <h3 className="font-semibold text-purple-400 mb-2">주요 지역</h3>
                ...
                <div className="bg-slate-800 rounded-lg p-4">
                  <h3 className="font-semibold text-purple-400 mb-2">특별 서비스</h3>
                  <ul className="text-slate-300 text-sm space-y-1">
                    <li>• 24시간 운영</li>
                    <li>• 30분 내 도착</li>
                    <li>• 카드결제 가능</li>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-purple-600 hover:bg-purple-700 text-white flex-1" asChild>
            ...
            <div className="bg-slate-800 rounded-lg p-6 shadow-2xl">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-semibold text-purple-400 mb-3">타이 마사지</h4>
                  <div className="grid grid-cols-3 gap-2 text-sm">
                    <div className="bg-slate-700 rounded p-3 text-center">
                      <div className="text-white font-semibold">60분</div>
                      <div className="text-purple-400 font-bold">80,000원</div>
                    </div>
                    <div className="bg-slate-700 rounded p-3 text-center">
                      <div className="text-white font-semibold">90분</div>
                      <div className="text-purple-400 font-bold">100,000원</div>
                    </div>
                    <div className="bg-slate-700 rounded p-3 text-center">
                      <div className="text-white font-semibold">120분</div>
                      <div className="text-purple-400 font-bold">120,000원</div>
                    </div>
                  </div>
                </div>

                <div>
                  <h4 className="text-lg font-semibold text-purple-400 mb-3">힐링스웨디시</h4>
                  <div className="grid grid-cols-3 gap-2 text-sm">
                    <div className="bg-slate-700 rounded p-3 text-center">
                      <div className="text-white font-semibold">60분</div>
                      <div className="text-purple-400 font-bold">90,000원</div>
                    </div>
                    <div className="bg-slate-700 rounded p-3 text-center">
                      <div className="text-white font-semibold">90분</div>
                      <div className="text-purple-400 font-bold">110,000원</div>
                    </div>
                    <div className="bg-slate-700 rounded p-3 text-center">
                      <div className="text-white font-semibold">120분</div>
                      <div className="text-purple-400 font-bold">130,000원</div>
                    </div>
                  </div>
                </div>
      ...
      <footer className="bg-slate-800 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-2xl font-bold text-purple-400 mb-4">총알출장마사지</h3>
            <p className="text-slate-300 mb-6">인천 강화군 전문 출장마사지 서비스</p>
            <div className="flex justify-center space-x-6">
              <a href="tel:010-2871-2457" className="text-slate-300 hover:text-purple-400 transition-colors">
                전화: 010-2871-2457
              </a>
            </div>

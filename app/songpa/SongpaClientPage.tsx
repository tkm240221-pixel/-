  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-violet-600 to-purple-600 text-white py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-4">송파구 출장마사지 예약 안내</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">송파구 출장마사지 특징</h2>
      ...
      <section className="py-16 bg-gradient-to-br from-violet-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">송파구 서비스 지역</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">송파구 고객 후기</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-violet-50 to-purple-50 rounded-xl p-6">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-gray-600">잠실동 김**님</span>
              </div>
              <p className="text-gray-700">
                "송파구에서 이렇게 전문적인 마사지를 받을 수 있어서 정말 만족합니다. 테라피스트분이 매우 친절하고 실력도
                뛰어나네요."
              </p>
            </div>
            <div className="bg-gradient-to-br from-violet-50 to-purple-50 rounded-xl p-6">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-gray-600">석촌동 이**님</span>
              </div>
              <p className="text-gray-700">
            ...
            <div className="bg-gradient-to-br from-violet-50 to-purple-50 rounded-xl p-6">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-gray-600">가락동 박**님</span>
              </div>
              <p className="text-gray-700">
                "24시간 언제든 예약할 수 있어서 너무 편리해요. VIP 패키지는 정말 최고입니다. 송파구 최고의 출장마사지
                서비스!"
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">송파구 전문 출장마사지 서비스</p>
            </div>
            <div>
          ...
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-gray-900">송파구 출장마사지 상세 요금표</h2>
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-600 mb-4">* 모든 가격은 송파구 지역 기준이며, 부가세 포함 가격입니다.</p>

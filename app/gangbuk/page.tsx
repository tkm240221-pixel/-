  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-violet-50 to-purple-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">강북구 출장마사지</h1>
            <p className="text-xl text-gray-600 mb-8">강북구 전 지역 30분 내 방문 프리미엄 마사지</p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">강북구 출장마사지 서비스 특징</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-violet-50 rounded-xl">
              ...
              <p className="text-gray-600">강북구 전 지역 24시간 언제든지 방문 가능합니다</p>
            </div>
      ...
      <section className="py-16 bg-gradient-to-br from-violet-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">강북구 고객 후기</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-gray-600">강북구 수유동</span>
              </div>
              <p className="text-gray-700">
                "강북구에서 이렇게 좋은 마사지 서비스를 받을 수 있어서 정말 만족합니다. 테라피스트분이 매우 전문적이고
                친절하셨어요."
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-gray-600">강북구 미아동</span>
              </div>
              <p className="text-gray-700">
                "미아동에서 30분 내에 와주셔서 너무 편리했습니다. 마사지 실력도 정말 좋고 다음에도 꼭 이용하겠습니다."
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-gray-600">강북구 번동</span>
              </div>
              <p className="text-gray-700">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">강북구 전 지역 프리미엄 출장마사지 서비스</p>
              <p className="text-gray-400">24시간 연중무휴 운영</p>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">서비스 지역</h4>
              <p className="text-gray-300">강북구 전 지역</p>

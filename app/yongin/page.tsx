  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-violet-600 to-purple-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-violet-100">
            용인시 전 지역 30분 내 방문 • 경험 많은 전문 테라피스트 • 100% 안전한 힐링 서비스
          </p>
      ...
      <section className="py-16 bg-violet-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">강서구 출장마사지 서비스 특징</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-gray-600">김○○ (처인구)</span>
              </div>
              <p className="text-gray-700">
                "용인시에서 이렇게 전문적인 마사지 서비스를 받을 수 있어서 정말 만족합니다. 테라피스트분이 매우 친절하고
                실력도 뛰어나네요."
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-gray-600">박○○ (기흥구)</span>
              </div>
              <p className="text-gray-700">
                "24시간 서비스라서 늦은 시간에도 이용할 수 있어 좋았습니다. 기흥구까지 빠르게 와주셔서 감사했어요."
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-gray-600">이○○ (수지구)</span>
              </div>
              <p className="text-gray-700">
                "VIP 코스를 이용했는데 정말 만족스러웠습니다. 수지구에서 이런 퀄리티의 서비스를 받을 수 있다니
                놀랍네요."
              </p>
            </div>
          </div>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h3 className="text-2xl font-bold mb-4">용인시 출장마사지 예약</h3>

...
export default function GoyangMassage() {
  const [displayText, setDisplayText] = useState("")
  const [showModal, setShowModal] = useState(false)
  const fullText = "고양시 출장마사지 예약 가이드"
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Badge className="mb-4 bg-violet-100 text-violet-800">고양시 전문 서비스</Badge>
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">고양시 출장마사지</h1>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            일산동구, 일산서구, 덕양구 등 고양시 전 지역
            <br />
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">고양시 출장마사지 서비스 특징</h2>
      ...
      <section id="areas" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 text-center mb-12">고양시 서비스 지역</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">고양시 고객 후기</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-l-4 border-l-violet-500">
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-2 text-gray-600">일산동구 고객</span>
                </div>
                <p className="text-gray-700">
                  "일산동구에서 이용했는데 정말 만족스러웠어요. 테라피스트분이 매우 전문적이고 친절하셨습니다. 피로가
            ...
            <Card className="border-l-4 border-l-purple-500">
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-2 text-gray-600">덕양구 고객</span>
                </div>
                <p className="text-gray-700">
                  "덕양구 지역인데 30분 만에 도착해주셨어요. VIP 코스 받았는데 정말 시원하고 개운했습니다. 가격도
                  합리적이고 서비스 품질이 훌륭해요."
                </p>
              </CardContent>
            </Card>
            <Card className="border-l-4 border-l-amber-500">
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-2 text-gray-600">일산서구 고객</span>
                </div>
                <p className="text-gray-700">
                  "일산서구에서 늦은 시간에 예약했는데도 친절하게 응대해주셨어요. 마사지 실력도 뛰어나고 전체적으로 매우
                  만족스러운 서비스였습니다."
                </p>
              </CardContent>
            </Card>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">고양시 출장마사지 예약</h2>
          ...
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold text-gray-900">고양시 출장마사지 코스표</h2>

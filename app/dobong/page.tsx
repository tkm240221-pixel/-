      ...
      <main>
        ...
        <section className="bg-gradient-to-br from-violet-600 to-purple-700 text-white py-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">도봉구 출장마사지</h1>
            <p className="text-xl mb-8 text-violet-100">쌍문동, 방학동, 창동 지역 전문 서비스</p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-900">도봉구 전문 서비스</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-white rounded-lg shadow-sm border border-violet-100">
                ...
                <p className="text-gray-600">도봉구 전 지역 24시간 출장 서비스</p>
              </div>
              <div className="text-center p-6 bg-white rounded-lg shadow-sm border border-violet-100">
        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-900">도봉구 서비스 지역</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-violet-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold mb-4 text-violet-800">주요 서비스 지역</h3>
                <ul className="space-y-2 text-gray-700">
                  <li>• 쌍문동 - 쌍문역, 방학역 인근</li>
                  <li>• 방학동 - 방학역, 도봉산역 인근</li>
                  <li>• 창동 - 창동역, 도봉구청 인근</li>
                </ul>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300">도봉구 전 지역 24시간 출장 마사지 서비스</p>
            </div>
            <div>

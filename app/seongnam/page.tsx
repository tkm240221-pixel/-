...
export default function SeongnamMassage() {
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <section className="relative bg-gradient-to-br from-slate-800 to-slate-900 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Badge className="mb-4 bg-blue-900 text-blue-300">성남시 전문 서비스</Badge>
            <h1 className="text-4xl lg:text-6xl font-bold text-white mb-6">
              성남시 출장마사지
              <span className="text-blue-400 block">24시간 방문 서비스</span>
            </h1>
            <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              성남시 전 지역 30분 내 방문 가능한 프리미엄 출장마사지 서비스
              <br />
              분당구, 수정구, 중원구 등 성남시 어디든 신속하게 방문합니다
            </p>
      ...
      <section className="py-16 bg-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white text-center mb-12">성남시 서비스 지역</h2>
      ...
      <section className="py-16 bg-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-white text-center mb-12">성남시 출장마사지 요금표</h2>
      ...
      <section className="py-16 bg-blue-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-8">성남시 출장마사지 예약</h2>

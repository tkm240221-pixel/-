  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-violet-100 text-violet-800">광주시 전문 서비스</Badge>
            <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              광주시 출장마사지
              <span className="text-violet-600 block">24시간 방문 서비스</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              광주시 전 지역 30분 내 방문! 숙련된 전문 테라피스트가 직접 방문하여 최고의 힐링 서비스를 제공합니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">광주시 출장마사지 서비스 특징</h2>
          </div>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">광주시 서비스 지역</h2>
            <p className="text-gray-600">광주시 전 지역 30분 내 방문 서비스</p>
          </div>

          <div className="grid md:grid-cols-4 gap-6">
            <Card>
              <CardContent className="p-6 text-center">
                <h3 className="font-semibold text-violet-600 mb-3">경안동</h3>
                <p className="text-gray-600 text-sm">경안동 전 지역</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
                <h3 className="font-semibold text-violet-600 mb-3">송정동</h3>
                <p className="text-gray-600 text-sm">송정동 전 지역</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
                <h3 className="font-semibold text-violet-600 mb-3">곤지암읍</h3>
                <p className="text-gray-600 text-sm">곤지암읍 전 지역</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
                <h3 className="font-semibold text-violet-600 mb-3">도척면</h3>
                <p className="text-gray-600 text-sm">도척면 전 지역</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
                <h3 className="font-semibold text-violet-600 mb-3">남종면</h3>
                <p className="text-gray-600 text-sm">남종면 전 지역</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
                <h3 className="font-semibold text-violet-600 mb-3">중부면</h3>
                <p className="text-gray-600 text-sm">중부면 전 지역</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6 text-center">
                <h3 className="font-semibold text-violet-600 mb-3">초월읍</h3>
                <p className="text-gray-600 text-sm">초월읍 전 지역</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">광주시 고객 후기</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-700">
                  "경안동에서 이용했는데 정말 만족스러웠어요. 테라피스트분이 너무 친절하시고 실력도 좋으셔서 몸이 정말
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-700">
                  "송정동 거주하는데 30분 내에 정말 오셨어요. VIP 패키지 받았는데 가격 대비 정말 만족스럽습니다. 위생도
                  철저하게 관리하시네요."
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-700">
                  "곤지암읍에서 힐링스웨디시 받았는데 정말 시원했어요. 예약도 간편하고 서비스도 전문적이라 추천합니다!"
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <footer className="bg-gray-900 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6">광주시 전문 출장마사지 서비스</p>
            ...
            <div className="text-gray-400 text-sm">
              <p>운영시간: 24시간 연중무휴</p>
              <p className="mt-2">광주시 전 지역 30분 내 방문 서비스</p>
            </div>

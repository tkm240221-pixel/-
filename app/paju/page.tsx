...
export default function PajuMassage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">파주시 코스 & 요금표</h2>
      ...
      <section className="py-16 bg-violet-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">파주시 출장마사지 서비스 특징</h2>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">파주시 서비스 지역</h2>
      ...
      <section className="py-16 bg-violet-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-gray-800 mb-12">파주시 고객 후기</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-gray-600 text-sm">운정동 고객</span>
              </div>
              <p className="text-gray-700">
                "파주시에서 이렇게 전문적인 마사지 서비스를 받을 수 있어서 정말 만족합니다. 관리사분도 친절하시고 실력도
                뛰어나세요."
              </p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-gray-600 text-sm">금촌동 고객</span>
              </div>
              <p className="text-gray-700">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-gray-600 text-sm">교하동 고객</span>
              </div>
              <p className="text-gray-700">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300">파주시 전 지역 24시간 출장마사지 서비스</p>
            </div>
            <div>
              <h4 className="font-semibold mb-4">서비스 지역</h4>
              <p className="text-gray-300">파주시 전 지역 (운정동, 금촌동, 교하동, 문산읍 등)</p>
            </div>
            <div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200 flex justify-between items-center">
              <h2 className="text-2xl font-bold text-gray-800">파주시 출장마사지 요금표</h2>

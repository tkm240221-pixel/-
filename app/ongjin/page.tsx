...
export default function OngjinPage() {
  return (
      ...
      <section className="relative bg-gradient-to-br from-slate-800 to-slate-900 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <Badge className="mb-4 bg-purple-900 text-purple-300">옹진군 전문 서비스</Badge>
            <h1 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              인천 옹진군 출장마사지
              <span className="text-purple-400 block">프리미엄 홈케어</span>
            </h1>
            <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              인천 옹진군 전 지역 30분 내 방문! 숙련된 전문 테라피스트가 직접 방문하여 최고의 힐링 서비스를 제공합니다.
            </p>
          </div>

          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-white mb-6">옹진군 서비스 지역</h2>
      ...
      <footer className="bg-slate-800 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-slate-300 mb-6">인천 옹진군 전문 출장마사지 서비스</p>
